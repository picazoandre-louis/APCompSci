public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[][] candidates = {{"president", "Mordy Golding", "Shira Gotshalk", "Stephanie Evans", "Ray Villalobos"}, {"vice president", "Dona Sarkar", "Tyler Ahn", "Joe Camp", "Brandon LeBlanc"}, {"secretary", "Jason Howard", "Nikki Rubino", "Peggy Fisher", "Neil Edde"}, {"treasurer", "David Gassner", "Sharon Bennett", "Walt Ritscher", "Heather Hurley"}}; // {row{column), row{column}}
        data = idScan(data);
